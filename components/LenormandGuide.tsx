        ...
        <CardContent className="space-y-lg">
          ...
          >
            <CollapsibleTrigger asChild>
              <Button
                variant="ghost"
                className="w-full justify-between rounded-lg p-md hover:bg-muted"
              >
            ...
            <CollapsibleContent className="mt-md space-y-md rounded-lg border border-border bg-card p-md">
              ...
              <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="rounded-lg bg-muted p-md">
                  <h4 className="mb-sm font-medium text-foreground">
                    Direct & Practical
                  </h4>
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                <div className="rounded-lg bg-muted p-md">
                  ...
                  <ul className="space-y-1 text-xs text-muted-foreground">
                    <li>
                      <strong>Past:</strong> What led to this
                    </li>
                    <li>
                      <strong>Present:</strong> Current situation
                    </li>
                    <li>
                      <strong>Future:</strong> Where it&apos;s heading
                    </li>
                  </ul>
                </div>
                <div className="rounded-lg bg-muted p-md">
                  ...
                  <ul className="space-y-1 text-xs text-muted-foreground">
                    <li>
                      <strong>Past:</strong> Background
                    </li>
                    <li>
                      <strong>Present:</strong> Current state
                    </li>
                    <li>
                      <strong>Future:</strong> What&apos;s coming
                    </li>
                    <li>
                      <strong>Challenge:</strong> Obstacles
                    </li>
                    <li>
                      <strong>Advice:</strong> Guidance
                    </li>
                  </ul>
                </div>
                <div className="rounded-lg bg-muted p-md">
                  ...
                  <ul className="space-y-1 text-xs text-muted-foreground">
                    <li>
                      <strong>Center:</strong> Core issue
                    </li>
                    <li>
                      <strong>Around:</strong> Influences
                    </li>
                    <li>
                      <strong>Corners:</strong> Outcomes
                    </li>
                  </ul>
                </div>
              </div>
              <p className="mt-md text-sm text-muted-foreground">
                <strong>Tip:</strong> Hover over position labels to see detailed
                explanations of what each position represents in your reading.
              </p>
            </CollapsibleContent>
          </Collapsible>
          ...
          >
            ...
            <CollapsibleContent className="mt-md space-y-md rounded-lg border border-border bg-card p-md">
              ...
              <div className="mt-lg rounded-lg border border-border bg-muted p-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Keep a reading journal! Note your questions, cards drawn, and
                  how the reading played out. This helps you learn patterns and
                  develop your personal connection with the cards.
                </p>
              </div>
            </CollapsibleContent>
          </Collapsible>
