export const LENORMAND_CARDS = [
  {
    ...
    description:
      "A messenger bringing news or swift movement. Energy and vitality in motion.",
  ...
  },
  {
    ...
    description:
      "A small blessing or moment of good luck. Small opportunities and brief happiness.",
  ...
  },
  {
    ...
    description:
      "Movement and travel. A journey in progress, literal or metaphorical.",
  ...
  },
  {
    ...
    description:
      "Growth, strength and health. Roots running deep, slow but steady progress.",
  ...
  },
  {
    ...
    description:
      "Confusion and unclear thinking. Mystery and hidden information.",
  ...
  },
  {
    ...
    description:
      "Deception or twists. Also transformation through wisdom and healing.",
  ...
  },
  {
    ...
    description:
      "An ending or major transition. Release from what no longer serves.",
  ...
  },
  {
    ...
    description:
      "Communication and conversation. Quick discussions and light chatter.",
  ...
  },
  {
    ...
    description:
      "New beginnings and innocence. Fresh starts and unlimited potential.",
  ...
  },
  {
    ...
    description:
      "Cunning and strategic thinking. Deception or clever maneuvering.",
  ...
  },
  {
    ...
    description:
      "Strength and power. Authority and protection. Wealth and abundance.",
    playingCard: "10 of Clubs",
    combinations: {
  ...
  },
  {
    ...
    description:
      "Hope and inspiration. Spiritual guidance and divine connection.",
  ...
  },
  {
    ...
    description:
      "Authority and official structures. Government and institutional power.",
  ...
  },
  {
    ...
    description:
      "Public life and community. Social gatherings and shared spaces.",
  ...
  },
  {
    ...
    description:
      "Written communication and documents. Official messages and information.",
  ...
  },
  {
    ...
    description:
      "The first person in the reading (not necessarily male). Central figure, primary focus, the querent's perspective.",
  ...
  },
  {
    ...
    description:
      "The second person in the reading (not necessarily female). Another key player, secondary focus, related person's perspective.",
  ...
  },
  {
    ...
    description:
      "Success and happiness. Clarity and vital energy. Very positive.",
  ...
  },
  {
    ...
    description:
      "Solutions and answers. Unlocking potential and clear success.",
