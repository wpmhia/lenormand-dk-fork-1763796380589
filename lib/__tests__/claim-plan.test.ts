...
describe("deterministic ClaimPlan", () => {
  it("keeps the question predicate and pair provenance explicit", () => {
    ...
    const context = buildReadingContext("sentence-3", "Will Alex stay with me?", cards, new Map(), "both", "", {
      mode: "forecast",
      domain: "love",
      predicate: "stay",
      subject: "Alex",
    ...
    expect(questionClaim).toMatchObject({ subject: "Alex", predicate: "stay", object: "questioner" });
