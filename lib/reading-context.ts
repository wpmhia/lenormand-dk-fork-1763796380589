...
const QUESTION_DOMAIN_KEYWORDS: Record<Exclude<QuestionDomain, "general">, string[]> = {
  ...
  love: ["love", "relationship", "partner", "romance", "marriage", "married", "dating", "boyfriend", "girlfriend", "wife", "husband", "spouse", "liefde", "relatie", "partner", "romantiek", "huwelijk", "getrouwd", "vriend", "vriendin", "mijn vrouw", "jouw vrouw", "uw vrouw", "echtgenote", "echtgenoot", "kærlighed", "forhold", "ægteskab", "gift", "kone", "min mand", "min kone", "kæreste"],
