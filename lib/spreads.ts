...
export const CORE_SPREADS: Spread[] = [
  { id: "past-present-future", cards: 3, label: "3-Card Reading: Past-Present-Future", description: "Classic timeline reading" },
...
export const ADVANCED_SPREADS: Spread[] = [
  ...
  { id: "sentence-3", cards: 3, label: "3-Card: Sentence Reading", description: "Flowing 3-card sentence interpretation" },
