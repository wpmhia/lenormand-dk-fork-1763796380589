      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Your privacy and trust are paramount. We are transparent about how we collect, use, and protect your information.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Card className="border-border bg-muted">
            ...
            <CardContent className="space-y-4 text-foreground">
               ...
               <p className="text-sm text-muted-foreground mt-4">
                 <strong>Key Principle:</strong> Your readings remain entirely private and are stored only on your device unless you choose to share them via URL. We cannot and do not access your reading history.
               </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-muted">
            ...
            <CardContent className="space-y-4 text-foreground">
               <p>
                Your data security is protected through multiple technical and organizational measures:
               </p>
               <ul className="ml-4 list-inside list-disc space-y-2">
                 ...
                 <li><strong>Transparent Infrastructure:</strong> We use industry-standard cloud providers with SOC 2 compliance and regular security audits.</li>
               </ul>
            </CardContent>
           </Card>
           ...
           <Card className="border-border bg-muted">
             ...
             <CardContent className="space-y-4 text-foreground">
                <p>
                  We use cookies and analytics to improve your experience while respecting your privacy:
                </p>
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="ml-4 mt-2 list-inside list-disc space-y-1 text-sm text-muted-foreground">
                      <li>Session management (keeping you logged in if needed)</li>
                      <li>Security and fraud prevention</li>
                      <li>Site functionality (dark mode, language preferences)</li>
                    </ul>
                    <p className="text-sm text-muted-foreground mt-2">
                      Essential cookies are always enabled and cannot be disabled, as the site cannot function without them.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground">Analytics Cookies</h4>
                    <p className="text-sm text-muted-foreground">
                      We use Google Analytics 4 (GA4) to understand visitor behavior and improve our services. This is completely optional.
                    </p>
                    <ul className="ml-4 mt-2 list-inside list-disc space-y-1 text-sm text-muted-foreground">
                      ...
                      <li>Geographic location (country/region, not specific addresses)</li>
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  <strong>Your Control:</strong> You can manage your cookie preferences at any time using the cookie settings banner at the bottom of the page. Declining analytics cookies does not affect site functionality—you can use all features freely.
                </p>
             </CardContent>
           </Card>
           ...
           <Card className="border-border bg-muted">
            ...
            <CardContent className="space-y-4 text-foreground">
              <ul className="ml-4 list-inside list-disc space-y-2">
                  ...
                  <li><strong>Cookie Management:</strong> Manage cookie preferences at any time using the cookie consent banner or privacy settings. You can withdraw analytics consent without affecting site functionality.</li>
                  <li><strong>Do Not Track:</strong> If your browser has &quot;Do Not Track&quot; enabled, we respect this preference.</li>
                </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-muted">
            ...
            <CardContent className="space-y-4 text-foreground">
               ...
               <p className="text-sm text-muted-foreground mt-4">
                 <strong>Policy Updates:</strong> This policy is effective as of November 2024. We may update it to reflect changes in our practices, technology, or legal requirements. We will notify you of any material changes by posting the updated policy here and updating the effective date. Your continued use of the site after changes constitutes acceptance of the updated policy.
               </p>
            </CardContent>
          </Card>
        </div>
