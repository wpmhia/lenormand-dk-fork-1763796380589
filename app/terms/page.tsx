           ...
           <Card className="border-border bg-muted">
             ...
             <CardContent className="space-y-4 text-foreground">
               <div className="space-y-4">
                 <div>
                   <h2 className="mb-4 font-semibold text-foreground">Entertainment Purpose</h2>
                ...
                <div>
                   <h2 className="mb-4 font-semibold text-foreground">No Professional Advice</h2>
                 ...
                 <div>
                   <h2 className="mb-4 font-semibold text-foreground">Age Requirement</h2>
