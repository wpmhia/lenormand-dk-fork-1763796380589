...
const combinationContexts: CombinationContext[] = [
  {
    ...
    description: "Combinations that reveal matters of the heart, relationships, and romantic connections",
    combinations: [
      {
        cards: "Rider + Lover",
        meaning: "Fast-moving romantic news or a new romantic connection approaching",
        context: "Someone is coming to confess feelings or propose a romantic relationship"
      },
      {
        cards: "Lover + Heart",
        meaning: "Deep romantic love, passion, and emotional connection",
        context: "A sincere and heartfelt relationship or the confirmation of true love"
      },
      {
        cards: "Lover + Ring",
        meaning: "Marriage proposal, engagement, or long-term commitment",
        context: "A significant commitment is being made or promised in a relationship"
      },
      {
        cards: "Lover + Clouds",
        meaning: "Relationship confusion, misunderstandings, or unclear feelings",
      ...
      },
      {
        ...
        context: "A relationship with strong emotions - either very passionate or volatile"
      },
      {
        cards: "Lover + Tower",
      ...
      },
      {
        ...
        context: "Finding the solution to a romantic issue or confirming a commitment"
      },
      {
        cards: "Fox + Lover",
        meaning: "Deception in love, hidden attraction, or manipulation",
        context: "Someone is not being truthful or is playing games in a relationship"
      },
      {
        cards: "Snake + Lover",
        meaning: "Jealousy, betrayal, or a complicated woman affecting the relationship",
  ...
  },
  {
    ...
    description: "Combinations revealing financial situations, opportunities, and challenges",
    combinations: [
      {
      ...
      },
      {
        ...
        context: "Hidden costs, unclear financial terms, or money problems obscured"
      },
      {
        cards: "Abundance + Whip",
        meaning: "Financial struggle, repeated expenses, or stress about money",
        context: "Ongoing financial difficulties or repeated financial setbacks"
      },
      {
      ...
      },
      {
        ...
        context: "Be cautious of financial schemes or look for hidden financial aspects"
      },
      {
      ...
      },
      {
        ...
        context: "Secure financial foundation or locked-in financial arrangement"
      },
      {
        cards: "Rider + Abundance + Key",
        meaning: "Quick confirmation of financial gain or fast money resolution",
  ...
  },
  {
    ...
    description: "Combinations related to physical health, healing, and wellness",
    combinations: [
      {
      ...
      },
      {
        ...
        context: "Health condition is difficult to identify or treatment is unclear"
      },
      {
        cards: "Whip + Medicine",
  ...
  },
  {
    ...
    description: "Combinations for job situations, career growth, and professional matters",
    combinations: [
      {
        cards: "Rider + Whip",
      ...
      },
      {
        ...
        context: "Office politics, workplace trickery, or strategic workplace moves"
      },
      {
        cards: "Snake + Whip",
        meaning: "Complex work situation with complications",
        context: "Tangled workplace issues or complicated professional dynamics"
      },
      {
        cards: "Abundance + Whip",
  ...
  },
  {
    ...
    description: "Combinations for personal development, spirituality, and inner wisdom",
    combinations: [
      {
        cards: "Key + Heart",
      ...
      {
        cards: "Tower + Key",
        meaning: "Major life breakthrough or significant personal transformation",
  ...
  },
  {
    ...
    description: "Combinations for relationships, friendships, and social interactions",
    combinations: [
      {
        cards: "Rider + Lover",
        meaning: "Someone important is coming or news about someone special",
        context: "A key person is arriving or communicating about a relationship"
      },
      {
        cards: "Fox + Clover",
      ...
      {
        cards: "Clouds + Lover",
        meaning: "Unclear relationship status or confused feelings about someone",
  ...
  },
  {
    ...
    combinations: [
      ...
      {
        cards: "Whip + Any Card",
        meaning: "That card's meaning involves struggle, repetition, or intensity",
      ...
      },
      {
        ...
        meaning: "That card's meaning is complicated, delayed, or involves jealousy",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 id="card-combinations" className="mb-4 text-4xl font-bold text-foreground">
            Card Combinations & Meanings
          </h1>
          <p className="text-lg text-muted-foreground mb-4">
            Master the art of reading card combinations. In Lenormand, two or more cards create new meanings through their interaction. This comprehensive guide breaks down combinations across different life contexts.
          </p>
            ...
            <CardContent>
              <div className="space-y-4">
                {context.combinations.map((combo, comboIndex) => (
                  <div key={comboIndex} className="border-l-2 border-primary/50 pl-4 py-2">
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="font-semibold text-foreground">{combo.cards}</h4>
                      <Badge className="ml-2">{context.title}</Badge>
                    </div>
                    <p className="text-foreground mb-2">{combo.meaning}</p>
                    {combo.context && (
        ...
        <Card className="mb-8 border-border bg-card">
          <CardHeader>
            <CardTitle id="practice-tips">Tips for Mastering Combinations</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Begin with 2-card combinations before progressing to complex spreads. Master the fundamentals first.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h4 className="font-semibold text-foreground">Identify Modifiers</h4>
                <p className="text-muted-foreground text-sm">Look for Key, Clouds, Scythe, and Anchor cards first - these change the meaning of nearby cards.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Read combinations left to right as a narrative. What story do the cards tell together?</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h4 className="font-semibold text-foreground">Consider Context</h4>
                <p className="text-muted-foreground text-sm">Always consider the question and context of the reading. The same combination means different things in different situations.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">The best way to master combinations is through regular practice. Do daily 2-3 card readings to build muscle memory.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8 border-border bg-card">
          <CardHeader>
            <CardTitle id="exploring-further">Explore Individual Cards</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground mb-4">
              To deepen your understanding of combinations, explore how each individual card works with others:
            </p>
