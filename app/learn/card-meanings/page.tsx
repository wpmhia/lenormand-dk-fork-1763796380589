...
const cardMeanings = [
  ...
  { number: 27, name: "The Letter", keywords: ["Communication", "Documents", "News", "Information"], timing: "Written, formal", location: "Inbox, email, official correspondence", associations: ["Important mail", "Legal documents", "Messages", "Correspondence"] },
    { number: 28, name: "The Man", keywords: ["First person", "Primary position", "Querent", "Central focus"], timing: "Present moment", location: "The first person in the reading (primary perspective)", associations: ["The questioner", "Primary subject", "First person's perspective", "Primary key person"] },
    { number: 29, name: "The Woman", keywords: ["Second person", "Secondary position", "Other figure", "Related person"], timing: "Present moment", location: "The second person in the reading (secondary perspective)", associations: ["Secondary subject", "Other person", "Second person's perspective", "Related key person"] },
