...
const cardMeanings = [
  ...
  { number: 27, name: "The Letter", keywords: ["Communication", "Documents", "News", "Information"], timing: "Written, formal", location: "Inbox, email, official correspondence", associations: ["Important mail", "Legal documents", "Messages", "Correspondence"] },
   { number: 28, name: "The Man", keywords: ["You", "Central person", "Focus", "The querent"], timing: "Present moment", location: "The central focus person (use they/them if gender unknown)", associations: ["The questioner", "Authority figure", "Primary subject", "Key person in focus"] },
   { number: 29, name: "The Woman", keywords: ["Other person", "Secondary figure", "Another key player", "Influence"], timing: "Present moment", location: "Another key person or influence (use they/them if gender unknown)", associations: ["Secondary subject", "Another player", "Related person", "Influence in the situation"] },
