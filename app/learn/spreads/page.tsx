      ...
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Discover powerful spreads and advanced reading techniques to enhance
            your Lenormand practice.
          </p>
        ...
        <Card className="mb-8 border-border bg-card">
          ...
          <CardContent className="space-y-6">
            <p className="leading-relaxed text-card-foreground">
              ...
              reading technique, using all 36 cards in a 4×9 layout (four rows
              of nine cards). This is the exact method documented in 1820s
              handbooks and by eyewitnesses who watched her read for Joséphine
              and Napoleon. She stripped away later add-ons (houses, knighting,
              etc.) to focus on pure card interaction and position timing.
            </p>
            ...
            <div className="rounded-lg border border-primary/30 bg-primary/5 p-4">
              <p className="text-sm text-card-foreground">
                ...
                <strong>
                  Woman card represents another key person or secondary
                  influence
                </strong>
                . When gender is unknown or when reading for mixed-gender
                groups, the French linguistic convention uses the masculine form
                by default—a method that remains valid today. Always ask:{" "}
                <em>&quot;Who is central here?&quot;</em> rather than{" "}
                <em>&quot;What is their gender?&quot;</em>
              </p>
            </div>
            ...
            <div className="space-y-4 rounded-lg border border-border bg-muted/50 p-4">
              ...
              <ul className="space-y-2 text-sm text-card-foreground">
                <li>
                  • Shuffle the 36 cards while stating your question aloud
                  (concentrated intent)
                </li>
                <li>
                ...
                <li>
                  ...
                  <strong>without further shuffling</strong>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 rounded-lg border border-border bg-muted/50 p-4">
              ...
              <ul className="space-y-2 text-sm text-card-foreground">
                <li>
                  • <strong>Man</strong> card (28) = the central person (the
                  questioner or focus of the reading; use they/them if gender
                  unknown)
                </li>
                <li>
                  • <strong>Woman</strong> card (29) = another key person or
                  influence (secondary figure; use they/them if gender unknown)
                </li>
                <li>
                  • <strong>Child</strong> (13) or <strong>Dog</strong> (18) if
                  reading for a child or pet
                </li>
                <li>
                  • <strong>Heart</strong> (24) if the reading is about a
                  situation or emotion rather than a specific person
                </li>
                <li>
                  • Circle the significator with a token—everything radiates
                  from this point
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-3">
                <div className="rounded bg-card p-3">
                  ...
                  <p className="mt-1 text-xs text-card-foreground">
                    Read all nine cards in the significator&apos;s row left →
                    right. Cards left of significator are past; cards right are
                    future. Speak complete sentences describing the narrative.
                  </p>
                </div>
                <div className="rounded bg-card p-3">
                  <p className="font-semibold text-foreground">
                  ...
                  <p className="mt-1 text-xs text-card-foreground">
                    Read the four cards above → below the significator. Top card
                    = unconscious motive; bottom card = what pre-occupies them
                    most right now.
                  </p>
                </div>
                <div className="rounded bg-card p-3">
                  ...
                  <p className="mt-1 text-xs text-card-foreground">
                    The four cards directly adjacent (above, below, left,
                    right). Treat as a four-word telegram answering the question
                    in ten seconds.
                  </p>
                </div>
                <div className="rounded bg-card p-3">
                  ...
                  <p className="mt-1 text-xs text-card-foreground">
                    Cards at positions 1, 9, 28, 36 (four corners). Read
                    clockwise—this gives the overall complexion of the entire
                    reading.
                  </p>
                </div>
                <div className="rounded bg-card p-3">
                  ...
                  <p className="mt-1 text-xs text-card-foreground">
                    Leap one card in eight directions like a chess knight. Use
                    only if corners are ominous or question is complex.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 rounded-lg border border-border bg-muted/50 p-4">
              ...
              <ul className="space-y-2 text-sm text-card-foreground">
                <li>
                  • <strong>Columns</strong> represent weeks (or months for
                  long-range questions)
                </li>
                <li>
                  • <strong>First &quot;past&quot; card</strong> (left of
                  significator): count pip value = how many days ago the story
                  began
                </li>
                <li>
                  • <strong>First &quot;future&quot; card</strong> (right of
                  significator): count pip value = days until next concrete
                  event
                </li>
                <li>
            ...
            <div className="space-y-4 rounded-lg border border-border bg-muted/50 p-4">
              ...
              <ul className="space-y-2 text-sm text-card-foreground">
                ...
                <li>
                  • State the bottom-center card (position 36) as the &quot;last
                  page the cards have turned&quot;—your closing advice
                </li>
                <li>
                  • Never re-interpret after the closing card: &quot;The voice
                  falls silent after the final emblem&quot;
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border border-border bg-muted p-4">
              <p className="text-sm text-foreground">
                <strong>Historical Note:</strong> This is the fastest
                &quot;salon method&quot; that matches every eyewitness
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="space-y-3 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Begin with 3-card spreads to build confidence before moving to
                  larger layouts.
                </p>
              </div>
              ...
              <div className="space-y-3 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Regular practice with different spreads helps you understand
                  card interactions.
                </p>
              </div>
              ...
              <div className="space-y-3 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Record your readings and revisit them later to see how
                  accurate your interpretations were.
                </p>
              </div>
            </div>
          </CardContent>
