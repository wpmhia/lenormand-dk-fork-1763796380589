...
const playingCardAssociations = [
  {
    suit: "Hearts (Love, Emotion, Water)",
    icon: Heart,
    color: "text-rose-600",
    bgColor: "bg-rose-50 dark:bg-rose-950/20",
    meaning: "Emotions, relationships, intuition, love matters",
    cards: [
      "Rider (9♥)",
      "Clover (6♦)",
      "Tree (7♥)",
  ...
  {
    suit: "Clubs (Work, Health, Earth)",
    icon: Club,
    color: "text-emerald-600",
    bgColor: "bg-emerald-50 dark:bg-emerald-950/20",
    meaning: "Material world, work, health, practical matters",
    cards: [
      "Clouds (King♣)",
      "Snake (Queen♣)",
      "Coffin (9♦)",
  ...
  {
    suit: "Diamonds (Money, Action, Fire)",
    icon: Diamond,
    color: "text-amber-600",
    bgColor: "bg-amber-50 dark:bg-amber-950/20",
    meaning: "Money, action, change, energy, transformation",
    cards: [
      "Ship (10♠)",
      "House (King♥)",
      "Fox (9♣)",
  ...
  {
    suit: "Spades (Challenges, Authority, Air)",
    icon: Spade,
    color: "text-slate-600",
    bgColor: "bg-slate-50 dark:bg-slate-950/20",
    meaning: "Challenges, authority, thoughts, separation",
    cards: [
      "Lily (King♠)",
      "Anchor (9♠)",
      "Man (Ace♥)",
