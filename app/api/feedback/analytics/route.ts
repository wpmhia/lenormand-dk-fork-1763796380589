  ...
  try {
    ...
    return NextResponse.json({
      ...
      optimization: {
        status: "active",
        description:
          "Feedback is being collected and used to optimize AI readings",
        ...
        explanation: {
          systemHelpfulnessRate:
            "Overall system helpfulness across all spreads",
          spreads: "Helpfulness rate for each individual spread type",
          topPerformingVariants:
            "Best performing prompt variants ranked by helpfulness",
        },
        how_it_works: {
          ...
          step5:
            "Future readings can use high-performing variants preferentially",
