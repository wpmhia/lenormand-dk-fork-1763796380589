        ...
        <Card className="w-full">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl">
              Support Lenormand Intelligence
            </CardTitle>
            <CardDescription>
              Help keep this project free for everyone
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-center text-sm text-muted-foreground">
              Lenormand Intelligence is completely free - no subscriptions, no
              limits, no catches. If you find value in it, consider buying me a
              coffee to help cover costs.
            </p>
            ...
            <p className="text-center text-xs text-muted-foreground">
              You can also support by sharing Lenormand Intelligence with
              friends!
            </p>
          </CardContent>
        </Card>
